(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#modal-dossier-gdpr{display:flex;align-items:flex-start;gap:0.8rem;margin-bottom:2rem;}',
      '#modal-dossier-gdpr input[type=checkbox]{width:18px;height:18px;min-width:18px;accent-color:#6B7B3A;cursor:pointer;appearance:auto;-webkit-appearance:auto;opacity:1;position:relative;z-index:1;flex-shrink:0;}',
      '#modal-dossier-gdpr label{font-size:0.85rem;line-height:1.6;color:rgba(245,240,232,0.75);cursor:pointer;}',
      '#modal-dossier input[type=text],#modal-dossier input[type=email],#modal-dossier input[type=tel]{cursor:text;}#modal-dossier select{cursor:pointer;}',
